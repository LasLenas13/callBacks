...
// uniq(names, uniq => console.log(`The new names arraywith the duplicate items removed s ${uniq}`))
...
console.log(addFour(9)); 
console.log(addFour(18));
